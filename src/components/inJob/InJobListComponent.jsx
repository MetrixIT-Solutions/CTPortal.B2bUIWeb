...
const InJobListComponent = (props) => {
  ...
  const { injobCnt } = leadsListCountObj;
  const tCount = injobCnt || 0;
  ...
  return (
    <div className='wrapper'>
          ...
          <div className="content-header">
            <div className="d-flex align-items-center">
              <div className="mr-auto">
                <h3 className="page-title">In Job</h3>
                <div className="d-inline-block align-items-center">
                  <nav>
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item" aria-current="page">In Job</li>
                      <li className="breadcrumb-item active" aria-current="page">List</li>
                    </ol>
                  </nav>
                </div>
              </div>
              {((rolesObj?.access?.length >= 13 && rolesObj?.access[13]?.actions[2]?.isAlwd) || rolesObj?.appAcc) &&
          ...
          <section className="content">
            <div className='row'>
              <div className='col-md-12'>
                <div className='box'>
                  {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[4]?.isAlwd) || rolesObj?.appAcc) && <div className='box-body'>
                    <ul className='nav nav-pills nav-fill'>
                      <li className='nav-item b-1'>
                        <a onClick={() => statusClick('In Job')} className={`${status.includes('In Job') ? 'nav-link active' : 'nav-link'}`}>
                          <div className='text-center'>
                            <h5 className='font-weight-500'>{leadsListCountObj.injobCnt}</h5>
                            <p className={`${status.includes('In Job') ? 'mb-0' : 'mb-0'}`}>In Job</p>
                          </div>
                        </a>
                      </li>
                      <li className='nav-item b-1'>
                                    ...
                                    <div className='media ng-star-inserted'>
                                      <div className='media-body'>
                                            ...
                                            <div>
                                              <h5 className='padb5'>
                                                <span className='ng-star-inserted'>
                                                  <a onClick={() => window.open(`/#/consultants/in/job/view/${item.euUser}`)}>{item.euName}</a>
                                        ...
                                        {/* <div className='jobdetails-center'>
                                          {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[14]?.isAlwd) || rolesObj?.appAcc) && <>
                                        ...
                                        <div className='jobdetails-right'>
                                          <div className='rightside-btns'>
                                            <div className='dropdown' ref={(el) => cndtRef[item._id] = el}>
                                              {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[12]?.isAlwd) || rolesObj?.appAcc)
                                              ...
                                              {((rolesObj?.access?.length >= 13 && (rolesObj?.access[12]?.actions[1]?.isAlwd)) || rolesObj?.appAcc) &&
                                              <>
                                                ...
                                                <div className={classnames('dropdown-menu dropdown-menu-right', { 'show': cndtShow === item._id })}>
                                                  {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[1]?.isAlwd) || rolesObj?.appAcc) && <a className='dropdown-item' onClick={() => hashHistory.push(`/consultants/in/job/view/${item.euUser}`)} data-bs-toggle="tooltip" title="View Candidate Details"><i className="fa-regular fa-eye"></i>View Details</a>}
                                                  {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[5]?.isAlwd) || rolesObj?.appAcc) && <a className='dropdown-item' onClick={() => setStateData({ leadLfcModal: true, leadView: item })} data-bs-toggle="tooltip"
                                                    title="Lead Lifecycle"><i className='fa-solid fa-rotate'></i>Lifecycle</a>}
                                                  {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[15]?.isAlwd) || rolesObj?.appAcc) && <a className='dropdown-item' onClick={() => handleStatus(item, 'Background Verification')} data-bs-toggle="tooltip" title="Send to Bgv"><i className="fa-solid fa-bullhorn"></i>Send to Bgv</a>}
                                                  {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[12]?.isAlwd) || rolesObj?.appAcc) && <a className='dropdown-item' data-bs-toggle="tooltip" onClick={() => setStateData({showNotes: true, leadView: item})} title="Notes"><i className='fa-solid fa-notes-medical'></i>Notes</a>}
                                                  {((rolesObj?.access?.length >= 13 && rolesObj?.access[12]?.actions[10]?.isAlwd) || rolesObj?.appAcc) && <a className='dropdown-item' data-bs-toggle="tooltip" onClick={() => {}} title="InJob Meeting"><i className='fa-regular fa-handshake'></i>Meetings</a>}
                                                </div>
                                              </>}
                                            </div>
      ...
      <Modal show={statusModal} onHide={handleClose} size='lg'>
        <Modal.Header closeButton>
          <h5 className='mb-0'>In Job Status Update</h5>
        </Modal.Header>
        <Modal.Body>
...
export default InJobListComponent;
