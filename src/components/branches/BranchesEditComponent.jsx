...
import { allCapsAlphaNum, numebersOnly, initCaps, capHifenLetter, firstCharCaps } from '../../hooks/common';
import hashHistory from '../../hashHistory';
import Countries from '../../../public/data/Countries.json';

const BranchesEditComponent = (props) => {
  const { org, orgName, orgCode, obName, obCode, obEmID, obAltEmID, obWs, obGst, obPan, obCin, obTin, obSsn, obEin, obItin, obTan, hNum, area, zip, city, stateCode, countryCode, obMobCc, obAltMobCc, obMobNum, obAltMobNum, obStatus, obNotes, statesList, errMsg, disable } = props.state;
  const { handleCountryChange, handleStateChange, setStateData, handleUpdate } = props;
          ...
          <div className='content-header'>
            <div className='d-flex align-items-center'>
              <div className='mr-auto'>
                <h3 className='page-title'>Edit Branch</h3>
                  ...
                  <div className='bs-stepper mt-3'>
                    <div className='bs-stepper-content'>
                      <div className='row'>
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <select disabled={true} className='form-select' value={org}>
                              <option value={org}>{orgName + ' (' + orgCode + ')'}</option>
                            </select>
                          </div>
                        </div>
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <input type='text' className='form-control' autoFocus={true} placeholder='Branch Name' value={obName} onChange={(e) => setStateData({ obName: initCaps(e.target.value), errMsg: '' })} />
                          </div>
                        </div>
                        <div className='col-md-3'>
                          <div className='form-group'>
                        ...
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <div className='d-flex'>
                              <select className='form-select form-control' style={{ width: '70px' }} value={obMobCc} onChange={(e) => setStateData({ obMobCc: e.target.value })}>
                        ...
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <div className='d-flex'>
                              <select className='form-select form-control' style={{ width: '70px' }} value={obAltMobCc} onChange={(e) => setStateData({ obAltMobCc: e.target.value })}>
                                <option value='+1'>+1</option>
                                <option value='+91'>+91</option>
                              </select>
                              <div className="flex-grow-1">
                      ...
                      <div className='d-flex justify-content-center mt-2'>
                        <button type='button' className='btn btn-danger me-2' onClick={() => hashHistory.push('/organizations/branches')}>Back</button>
                        <button type='button' className='btn btn-primary' disabled={disable} onClick={handleUpdate}>Update</button>
                      </div>
                    </div>
                  </div>
                </div>
...
export default BranchesEditComponent