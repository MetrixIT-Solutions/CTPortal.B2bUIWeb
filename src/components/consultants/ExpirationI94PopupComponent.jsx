...
const ExpirationI94PopupComponent = (props) => {
  const {editmodal, isVrfdModal, num, strDt, expDt, errMsg, disabled, subObj} = props.state;
  ...
  return (
    <>
      <Modal show={editmodal} onHide={() => setStateData({editmodal: false, subObj: {}, errMsg: ""})} size="l">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group">
                  ...
                  <input type="text" className="form-control" placeholder="i94 Number" value={num} onChange={(e) => setStateData({num: initCaps(e.target.value), errMsg: ""})} />
                </div>
              </div>
              <div className="col-md-6">
                <div className="form-group">
                  <label>i-94 Start Date</label>
                  <span className="text-danger">*</span>
                  <input type="date" className="form-control" placeholder="i-94 Start Date" value={strDt} onChange={(e) => setStateData({strDt: e.target.value, expDt: "", errMsg: ""})} />
                </div>
              </div>
              <div className="col-md-6">
                <div className="form-group">
                  ...
                  <span className="text-danger">*</span>
                  <input type="date" className="form-control" placeholder="i-94 Expiry Date" value={expDt} min={strDt} onChange={(e) => setStateData({expDt: e.target.value, errMsg: ""})} />
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-12">
                ...
                <div className="d-flex justify-content-center mt-3">
                  <button type="button" className="btn btn-danger mr-3" onClick={handlecloseModal}>
                    Back
                  </button>
...
export default ExpirationI94PopupComponent;
