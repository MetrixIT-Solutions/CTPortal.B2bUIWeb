...
const ExpirationSSNPopupComponent = (props) => {
  const {editmodal, isVrfdModal, num, expDt, errMsg, disabled, isCheck, subObj} = props.state;
  ...
  return (
    <>
      <Modal show={editmodal} onHide={() => setStateData({editmodal: false, subObj: {}, errMsg: "", num: "", expDate: "", isCheck: false})} size="l">
...
export default ExpirationSSNPopupComponent;
