...
const OrgCreateComponent = (props) => {
  const { orgName, orgCode, orgMobNum, orgMobCc, orgEmID, orgStatus, orgNotes, hNum, area, aLocality, zip, stateCode, city, countryCode, orgWs, orgGst, orgPan, orgCin, orgTin, orgSsn, orgEin, orgItin, orgTan, errMsg, disable, statesArr, file, imgUrl, branchName, branchCode} = props.state;
  const { setStateData, handleCountryChange, handleCreate, handleStateChange, onImageChange, removeImage, fileInput, handleRouteHome } = props;
  return (
          ...
          <div className="content-header">
            <div className="d-flex align-items-center">
              <div className="mr-auto">
                <h3 className="page-title">Create Organization</h3>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-3">
                          <div className="form-group">
                            ...
                            <input type="text" className="form-control" placeholder="Code" maxLength={10} value={orgCode} onChange={(e) => setStateData({ orgCode: capHifenLetter(e.target.value), errMsg: '' })} />
                          </div>
                        </div>
                        <div className="col-md-3">
                          <div className="form-group">
                      ...
                      <div className='row mb-2 mt-2'>
                        <div className='col-md-12'>
                          ...
                          <div className="col-md-3">
                            ...
                            <div className="col-md-3">
                              <div className="form-group">
                                <label>Head Branch</label><span className='text-danger'>*</span>
                                <input type="text" className="form-control" placeholder="Head Branch"  value={branchName} onChange={(e) => setStateData({ branchName: capHifenLetter(e.target.value), errMsg: '' })} />
                              </div>
                            </div>
                            <div className="col-md-3">
                              <div className="form-group">
                                <label>Head Branch Code</label><span className='text-danger'>*</span>
                                <input type="text" className="form-control" placeholder="Head Branch Code" maxLength={10} value={branchCode} onChange={(e) => setStateData({ branchCode: allCapsAlphaNum(e.target.value).trim(), errMsg: '' })} />
                              </div>
                            </div>
                          </div>
                        </div>
