...
const AdminUserCreateComponent = (props) => {
  const { orgsList, rolesObj, teamsList, branchesList, rolesList, org, orgObj, obId, team, sName, fName, lName, password, showPswd, mobCc, mobNum, emID, userId, workUrl, altMobCc, altMobNum, altEmID, dob, gender, file, imgUrl, userRole, uStatus, /*buildingName, hNum, area, aLocality, zip, cCode, sCode, statesArr, city, userType, plusCode, latitude, longitude,*/ disable, errMsg, userInfo, userType, report, userList, joinDte, descNum, extnsn, descLoc, years, months, descNumCode } = props.state;
  const { setStateData, handleOnChange, /*handleCountryChange, handleStateChange, handleGetCoordinates*/ onImageChange, removeImage, fileInput, handleCreateUser, handleRouteHome, handleUserType, handleRolesChange, handleReportChange, handleTeamChange } = props;
          ...
          <div className='content-header'>
            <div className='d-flex align-items-center'>
              <div className='mr-auto'>
                <h3 className='page-title'>Create Admin User</h3>
                ...
                <div className='row'>
                  <div className='col-md-3'>
                    <div className='form-group'>
                      <label>Organization</label>{rolesObj?.appAcc && <span className='text-danger'>*</span>}
                      {rolesObj?.appAcc ? <select className="form-select form-control" name='orgCode' value={org} onChange={(e) => handleOnChange(e, 'org')}>
                  ...
                  <div className='col-md-3'>
                    <div className='form-group'>
                      <div className='d-flex'>
                        <label>Password <span className='text-danger'>*</span></label><TooltipComponent position={position} password={true} /> 
                      </div>
                      <div className="input-group">
                        <input type={`${!showPswd ? 'password' : ''}`} className="form-control bg-transparent" placeholder="Password" maxLength={20} value={password} onChange={(e) => setStateData({ password: e.target.value, errMsg: '' })} />
                  ...
                  <div className='col-md-3'>
                    <div className='form-group'>
                      ...
                      <div className='d-flex'>
                        ...
                        <input type='text' className='form-control' placeholder='Extension'  maxLength={10} value={extnsn}  onKeyPress={numebersOnly} onChange={(e) => setStateData({ extnsn: e.target.value, errMsg: '' })} style={{ borderBottomLeftRadius: 0, borderTopLeftRadius: 0 }} />
                      </div>
                    </div>
                  </div>
                  <div className='col-md-3'>
                  ...
                  <div className='col-md-3'>
                    <div className='form-group'>
                      ...
                      <input type='text' className='form-control' placeholder='Linkedin ID' name='Linkedin ID' maxLength={80} value={workUrl} onChange={(e) => setStateData({ workUrl: e.target.value ? [e.target.value] : [], errMsg: '' })} />
                    </div>
                  </div>
                  <div className='col-md-3'>
                    <div className="mb-3">
                  ...
                  <div className='d-flex justify-content-center'>
                    ...
                    <button className='btn btn-primary text-center' disabled={disable} onClick={handleCreateUser}>Create</button>
                  </div>
                </div>
              </div>
            </div>
