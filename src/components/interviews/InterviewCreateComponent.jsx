...
const InterviewCreateComponent = (props) => {
  const { scrType, invDate, invTime, timeZone, hrs, mins, canName, canMobNum, canMobCc, jobTitle, jobId, jobDesc, invNotes, invPmem, testCompany, file, imgUrl, cCode, sCode, ards, area, city, zip, statesArr, client, skills, vType, companyName, vName, emId, mobCc, mobNum, errMsg,disable, subObj, invWith, round } = props.state;
  const { setStateData, handleCreate, handleOnchange, removeImage, fileInput } = props;
  return (
                  ...
                  <div className='bs-stepper mt-3'>
                    <div className='bs-stepper-content'>
                      <div className='row'>
                        <div className='col-md-2'>
                          <div className='form-group'>
                            ...
                            <select className='form-select form-control' id='participants6' value={scrType} onChange={(e) => setStateData({ scrType: e.target.value, errMsg: '' })}>
                        ...
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <input type='text' className='form-control' placeholder='Candidate Name' value={canName} disabled={true} onChange={(e) => setStateData({ canName: e.target.value, errMsg: '' })} />
                          </div>
                        </div>
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <div className='d-flex'>
                              ...
                              <div className='flex-grow-1'>
                                <input type='text' className='form-control' placeholder='Candidate Mobile Number' onKeyPress={numebersOnly} maxLength={10}  disabled={true} value={canMobNum} onChange={(e) => setStateData({ canMobNum: e.target.value, errMsg: '' })} />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        {file && <div className='col-md-2'>
                          <div className='d-inline-flex mt-1 position-relative'>
                            <div className='add-img'>
                              <img src={imgUrl} alt={file.name} style={{ width: 150 }} className="img-fluid me-2" />
                            </div>
                            <div className='close-bth'>
                              <a onClick={removeImage}><i className="fa-solid fa-xmark text-danger"></i></a>
                            </div>
                          </div>
                        </div>}
                        <div className='col-md-3'>
                        ...
                        <div className='col-md-5'>
                          <div className='form-group'>
                            ...
                            <textarea name='decisions' id='decisions3' rows='3' className='form-control' value={jobDesc} disabled={true} onChange={(e) => setStateData({ jobDesc: e.target.value, errMsg: '' })}></textarea>
                          </div>
                        </div>
                        </div>
                        <div className='row'>
                          ...
                          <div className='col-md-12'>
                            ...
                            <div className='row'>
                              <div className='col-md-3'>
                                <div className='form-group'>
                                  <label>Type</label>
                                  <select className='form-select form-control' value={subObj.pvipType} disabled={true}>
                                    <option value=''>Select Type</option>
                                    <option value='Prime Vendor'>Prime Vendor</option>
                                    <option value="Implementation Partner">Implementation Partner</option>
                                  </select>
                              ...
                              <div className='col-md-3'>
                                <div className='form-group'>
                                  ...
                                  <input type='text' className='form-control' placeholder='Company Name' value={subObj.pvipName} disabled={true}/>
                                </div>
                              </div>
                              <div className='col-md-3'>
                                <div className='form-group'>
                                  <label>Name</label>
                                  <input type='text' className='form-control' placeholder='Name' value={subObj.pvipcPerson} disabled={true} />
                                </div>
                              </div>
                              <div className='col-md-3'>
                                <div className='form-group'>
                                  <label>Email ID</label>
                                  <input type='text' className='form-control' placeholder='Email ID' value={subObj.pvipcEmail} disabled={true} />
                                </div>
                              </div>
                              <div className='col-md-3'>
                                <div className='form-group'>
                                  ...
                                  <div className='d-flex'>
                                    <select className='form-select form-control' style={{ width: '70px' }} value={subObj.pvipcMobCc} disabled={true}>
                                      <option value='+1'>+1</option>
                                      <option value='+91'>+91</option>
                                    </select>
                                    <div className='flex-grow-1'>
                                      <input type='text' className='form-control' placeholder='Mobile Number' maxLength={10} value={subObj.pvipcMobNum} disabled={true}/>
                                    </div>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div className='d-flex justify-content-center mt-2'>
                        <button className='btn btn-danger mr-2' onClick={ async () => { await localForage.setItem('tabValue', 'sub'), hashHistory.push('/submissions') }}>Back</button>
...
export default InterviewCreateComponent;
