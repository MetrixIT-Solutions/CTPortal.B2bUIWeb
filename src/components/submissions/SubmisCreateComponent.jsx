...
const SubmisCreateComponent = (props) => {
  const { deleteModal, subDate, jobTitle, jobId, status, skills, jobDesc, prHr, prNotes, cCode, sCode, statesArr, adrs, area, city, zip, vType, companyName, vName, emId, mobNum, mobCc, client, errMsg, disable, consList, canObj, file, imgUrl, pvipType, pvipName, pvipcPerson, pvipcMobCc, pvipcMobNum, pvipcEmail, sNotes, orgId, orgsList, userInfo, rolesObj, cmnModal, cmnValue, cmnErrMsg, cmnSkillArr, cmnJbTitleArr, cmnType } = props.state
  const { setStateData, handleCountryChange, handleCreate, handleOnchange, removeImage, fileInput, handleJbTitleChange, handleChangeOrg, handleCreateSkill } = props;
          ...
          <div className='content-header'>
            <div className='d-flex align-items-center'>
              <div className='mr-auto'>
                <h3 className='page-title'>Create Submission</h3>
                  ...
                  <div className='bs-stepper mt-3'>
                      ...
                      <div className='row'>
                        {(userInfo?.userType == 'App' || userInfo?.userType == 'Tech' || (userInfo?.userType == 'Management' && userInfo?.userRole == 'Super Admin')) &&
                          <div className='col-md-3'>
                            <div className='form-group'>
                              ...
                              <select className='form-select form-control' value={orgId} onChange={handleChangeOrg}>
                        ...
                        <div className='col-md-3'>
                          <div className='form-group'>
                            ...
                            <select className='form-select form-control' value={status} onChange={(e) => setStateData({ status: e.target.value, errMsg: '' })}>
                              <option value=''>Select </option>
                          ...
                          <div className='form-group '>
                            ...
                            <div className='d-flex justify-content-between'>
                              <Select
                                ...
                                options={cmnSkillArr || []}
                                onChange={(data) =>
                                  setStateData({ skills: data.map(item => item.__isNew__ ? { label: initCaps(item.label), value: initCaps(item.value) } : item), errMsg: '' })}
                                className='w-100'
                              />
                        ...
                        <div className='col-md-6'>
                          <div className='form-group'>
                            ...
                            <textarea name='decisions' rows='2' className='form-control' value={jobDesc} onChange={(e) => setStateData({ jobDesc: firstCharCaps(e.target.value), errMsg: '' })}></textarea>
                          </div>
                        </div>
                      </div>
                    {((rolesObj?.access?.length >= 15 && rolesObj?.access[14]?.actions[10]?.isAlwd) || rolesObj?.appAcc) &&
                      <div className='row'>
                        ...
                        <div className='col-md-5'>
                          <div className='form-group'>
                            ...
                            <textarea type='text' className='form-control' rows='2' value={prNotes} onChange={(e) => setStateData({ prNotes: firstCharCaps(e.target.value), errMsg: '' })} />
                          </div>
                        </div>
                        <div className='col-md-2'>
                          <div className='form-group mt-1'>
                            <label className='mb-0'>RTR confirmation</label>{prHr && <span className='text-danger'>*</span>}<span><p className='mb-0 text-mute'><small>(File Type: image only)</small>{prHr && <span className='text-danger'>*</span>}</p> </span>
                        ...
                        {file && <div className='col-md-2'>
                          <div className='d-inline-flex mt-1 position-relative'>
                            <div className='add-img'>
                              <img src={imgUrl} alt={file.name} style={{ width: 100 }} className="img-fluid me-2" />
                            </div>
                              ...
                              <div className='row'>
                                <div className='col-md-3'>
                                  <div className='form-group'>
                                    ...
                                    <select className='form-select form-control' value={vType} onChange={(e) => setStateData({ vType: e.target.value, errMsg: '', pvipType: '', pvipName: '', pvipcPerson: '', pvipcMobCc: '+1', pvipcMobNum: '', pvipcMobCcNum: '', pvipcEmail: '', pvipClient: '' })}>
                                    ...
                                    <div className='form-group'>
                                      ...
                                      <div className='d-flex'>
                                        ...
                                        <div className='flex-grow-1'>
                                          <input type='text' className='form-control' placeholder='Mobile Number' onKeyPress={numebersOnly} maxLength={10} value={mobNum} onChange={(e) => setStateData({ mobNum: e.target.value, errMsg: '' })} />
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                    ...
                                    <div className='col-md-3'>
                                      <div className='form-group'>
                                        ...
                                        <div className='d-flex'>
                                          ...
                                          <div className='flex-grow-1'>
                                            <input type='text' className='form-control' placeholder='Mobile Number' maxLength={10} onKeyPress={numebersOnly} value={pvipcMobNum} onChange={(e) => setStateData({ pvipcMobNum: e.target.value, errMsg: '' })} />
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                      ...
                      <div className='d-flex justify-content-center mt-2'>
                        <button className='btn btn-danger mr-2' onClick={() => hashHistory.push('/submissions')}>Back</button>
                        <button className='btn btn-primary' disabled={disable} onClick={handleCreate}>Create</button>
                      </div>
                    </div>
                  </div>
                </div>
...
export default SubmisCreateComponent;
